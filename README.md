...
### Usage (Automatic)
The label maker and synchronisation utilises a CI pipeline (go.yml) that runs every day at 06:00 UTC time look out for any new repositories and apply the labels. You can use [crontab] to come up with the desired cron job time to run the workflow.
