...
### Usage (Automatic)
The label maker and synchronisation utilises a CI pipeline (label_maker.yml) that runs every hour to look out for any new repositories and apply the labels.
